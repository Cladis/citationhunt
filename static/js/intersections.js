...
var intersectionSpinner = new Spinner({
  scale: 0.5,
  top: 0,
...
$(function() {
  ...
  function IntersectionProgressCard(wizard) {
    var self = this;
    ...
    this.start = function($container, $ajax, spinner) {
      ...
      this.$inFlightRequest.always(function(response) {
        ...
        if (response !== null && response['error'] === undefined
          ...
          wizard.advanceToCard('intersection-card-failed');
        }
      });
    }
  ...
  IntersectionProgressCard.prototype = Card;
  ...
  function IntersectionFailedCard(wizard) {
    var id = 'intersection-card-failed';
    this.getId = () => id;
    var $html = $('#' + id).detach();
  ...
  IntersectionFailedCard.prototype = Card;
  ...
  function Wizard($container, $buttonBack, $buttonSubmit) {
    ...
    this.cards = [
      ...
      ImportArticlesCard,
      ImportPetScanCard,
      IntersectionProgressCard,
      IntersectionCreatedCard,
      IntersectionFailedCard,
    ...
    $buttonSubmit.click((e) => {
      ...
      if (promise !== null) {
        this.advanceToCard('progress-card', promise, intersectionSpinner);
      }
    });
